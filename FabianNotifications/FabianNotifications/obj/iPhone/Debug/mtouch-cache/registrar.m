...
void native_to_managed_trampoline_3 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, id p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
@interface AppDelegate : NSObject/*<UIApplicationDelegate>*/ {
	...
	-(void) application:(id)p0 didReceiveLocalNotification:(id)p1;
...
@implementation AppDelegate { } 
	...
	-(id) window
	{
		...
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIWindow, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_Window");
	}

	-(void) application:(id)p0 didReceiveLocalNotification:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_3 (self, _cmd, &managed_method, p0, p1, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MonoTouch.UIKit.UILocalNotification, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ReceivedLocalNotification");
	}

	-(bool) application:(id)p0 didFinishLaunchingWithOptions:(id)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, p1, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MonoTouch.Foundation.NSDictionary, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "FinishedLaunching");
	}

	-(void) applicationWillResignActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillEnterForeground");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end

@interface FabianNotificationsViewController : UIViewController {
	void *__monoObjectGCHandle;
}
	@property (nonatomic, assign) id buttonFireMe;
	-(void) release;
	-(id) retain;
	-(void) dealloc;
	-(id) buttonFireMe;
	-(void) setButtonFireMe:(id)p0;
	...
	-(bool) conformsToProtocol:(void *)p0;
@end
@implementation FabianNotificationsViewController { } 
	-(void) release
	{
		monotouch_release_trampoline (self, _cmd);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "FabianNotifications.FabianNotificationsViewController, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_buttonFireMe");
	}

	-(void) setButtonFireMe:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIButton, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "FabianNotifications.FabianNotificationsViewController, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_buttonFireMe");
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_7 (self, _cmd, &managed_method, "FabianNotifications.FabianNotificationsViewController, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidReceiveMemoryWarning");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_7 (self, _cmd, &managed_method, "FabianNotifications.FabianNotificationsViewController, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "FabianNotifications.FabianNotificationsViewController, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewDidAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "FabianNotifications.FabianNotificationsViewController, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidAppear");
	}

	-(void) viewWillDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "FabianNotifications.FabianNotificationsViewController, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}

	-(void) viewDidDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "FabianNotifications.FabianNotificationsViewController, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidDisappear");
	}
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "FabianNotifications.AppDelegate, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"FabianNotificationsViewController", "FabianNotifications.FabianNotificationsViewController, FabianNotifications, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [4].handle = [FabianNotificationsViewController class];
	...
	__monotouch_class_map [10].handle = objc_getClass ("UIAlertView");
	__monotouch_class_map [11].handle = objc_getClass ("UIApplication");
	__monotouch_class_map [12].handle = objc_getClass ("UIControl");
	__monotouch_class_map [13].handle = objc_getClass ("UIButton");
	__monotouch_class_map [14].handle = objc_getClass ("MonoTouch_UIKit_UIControlEventProxy");
	__monotouch_class_map [15].handle = objc_getClass ("UIDevice");
	__monotouch_class_map [16].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [17].handle = objc_getClass ("UILocalNotification");
	__monotouch_class_map [18].handle = objc_getClass ("UITraitCollection");
	__monotouch_class_map [19].handle = objc_getClass ("UIUserNotificationSettings");
	__monotouch_class_map [20].handle = objc_getClass ("NSEnumerator");
	__monotouch_class_map [21].handle = objc_getClass ("NSException");
	__monotouch_class_map [22].handle = objc_getClass ("NSDictionary");
	__monotouch_class_map [23].handle = objc_getClass ("NSSet");
